![docker image](https://github.com/siamakn/nomad-sintering-image/actions/workflows/docker-publish.yml/badge.svg)

# siamakn's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of siamakn. 
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/siamakn/nomad-sintering-image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/siamakn/nomad-sintering-image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/siamakn/nomad-sintering-image/manifests/main": unauthorized`
